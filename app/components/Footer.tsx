...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-white/95 dark:bg-black/95 backdrop-blur-md border-t border-black/10 dark:border-white/10 mt-auto">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 text-center md:text-left mb-4">
          ...
          <section className="flex flex-col justify-center items-center md:items-start">
            ...
            <div className="mt-6 flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
              ...
              <Button size="md" onClick={() => window.open('https://linktr.ee/ahmekhitran', '_blank')} icon={<Download className="w-4 h-4" />}>
                Visit Linktree
              </Button>
            </div>
          </section>
          ...
          <section className="flex flex-col justify-center items-center md:items-end">
            <div className="text-sm md:text-base text-black/60 dark:text-white/60 text-center md:text-right">
        ...
        <div className="border-t border-black/10 dark:border-white/10 pt-6 mt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-black/70 dark:text-white/70">
            <div className="hover:text-black dark:hover:text-white transition-colors flex items-center gap-4">
              <Link
                href={`mailto:${EMAIL}`}
